...
export default function Button({
  ...
  return (
    <a
      ...
      className={`py-[10px] px-4 font-medium text-white flex justify-center items-center relative overflow-hidden text-sm transition-[background-color] rounded-3xl ${styleTal}`}
      style={style}
    >
      <span className="children">{children}</span>{" "}
      <span className=" w-14 h-14 top-0 absolute cubito" ref={rounded} />
    </a>
  );
}
